  ...
  const defaultComponents = {
    Chevron: (chevronProps: {
      ...
      if (chevronProps.orientation === 'left') {
        return <ChevronLeft size={16} strokeWidth={2} className={chevronProps.className} aria-hidden="true" />;
      }
      return <ChevronRight size={16} strokeWidth={2} className={chevronProps.className} aria-hidden="true" />;
    },
  };
